...
define config.name = _("Date My Existance")
...
define build.name = "DeleteMyExistance"
...
define config.main_menu_music = "Cinematic_Tale.mp3"
...
define config.save_directory = "DeleteMyExistance-1695433631"
